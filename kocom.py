...
'''
 ...
 : forked from script written by vifrost, kyet, 룰루해피, 따분, Susu Daddy, lunark,
...
#    ret = { 'heat_mode': 'heat' if value[:2] == '11' else 'off',
    ret = { 'heat_mode': 'heat' if value[:4] == '1100' elseif 'away' if value[:4] == '1101' else 'off',
...
#        heatmode_dic = {'heat': '11', 'off': '00'}
        heatmode_dic = {'heat': '1100', 'away': '1101', 'off': '0000'}
